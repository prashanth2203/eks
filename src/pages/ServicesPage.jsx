...
import { ArrowRight, Server, Brain, Layers, ShieldCheck, LifeBuoy, Pickaxe } from 'lucide-react';
...
const SERVICES = [
  ...
  },
  {
    ...
    desc: 'ERP, e-Governance, and campus management at institutional scale. Single-database architectures proven across universities, state directorates, and public enterprises.',
    features: [
      'Proven deployment types: Campus & Higher Education ERP, State e-Governance, Enterprise Operations',
      'High-throughput admissions, web counselling & student lifecycle engines',
      'Confidential examination management with dummy masking & CAG audit compliance',
      'Large-scale multi-department & affiliated campus orchestration',
    ],
    ...
    <div>
      <section className="page-hero">
        <div className="container">
          ...
          <h1 className="page-hero__title">What we do.</h1>
